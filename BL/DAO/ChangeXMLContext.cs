...
namespace BL.DAO
{
    public class ChangeXMLContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SHPTEXT>().ToTable("SHPTEXT");
            modelBuilder.Entity<StatusRetorno>().ToTable("StatusRetorno");
            modelBuilder.Entity<TGTEPRD>().ToTable("TGTEPRD");
            modelBuilder.Entity<TGTERES>().ToTable("TGTERES");
            modelBuilder.Entity<TGTESHKN>().ToTable("TGTESHKN");
            modelBuilder.Entity<TGTESHPN>().ToTable("TGTESHPN");
